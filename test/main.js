...
const { Test, TestSuite } = require('./lib/driver')
  ...
  let admin_1       = new   admin.data.Admin   ('Admin')
    ...
    , journal_1     = new journal.data.Journal (client_1, client_1_addr, store_1, agent_1)
  ...
  [
    ...
    ,   agent.story.Std('Add Agent ',          admin_1,           agent_1                                                      )
    ,   store.story.Std('Add Store ',          admin_1, client_1,          store_1                                             )
    ,    note.story.Std('Set Notes',           admin_1, client_1,          store_1,   note_                                    )
    , product.story.Std('Add Product',                  client_1,          store_1,         product_1                          )
    , address.story.Std('Set Client Address',           client_1,                                      client_1_addr           )
    ,    cart.story.Std('Add Product to Cart',          client_1,          store_1,         product_1, client_1_addr           )
    , transit.story.Std(                                client_1, agent_1, store_1,                    client_1_addr           )
