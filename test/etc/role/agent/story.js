...
const Std = function(text_, arbiter_, agent_, journal_)
{
    ...
    [
        ...
        , new event.RegisterApprove     (agent_, arbiter_)
        ...
        , new event.List                (agent_, arbiter_)
...
const AddAgent = function(text_, arbiter_, agent_)
{
    let tc    = new TestCase(text_)
    const steps_ =
    [
